...
public static class EditorGUICustom
{
    ...
    public static readonly Color HighlightColor =
        EditorGUIUtility.isProSkin ? new Color(0.7f, 0.7f, 0.7f, 1f) : new Color(0.35f, 0.35f, 0.35f);

    public static readonly Color HeaderColor =
        EditorGUIUtility.isProSkin ? new Color(0.8f, 0.8f, 0.8f, 1f) : new Color(0.4f, 0.4f, 0.4f);

    public static readonly Color SeparatorColor =
        EditorGUIUtility.isProSkin ? new Color(0.16f, 0.16f, 0.16f) : new Color(0.5f, 0.5f, 0.5f);
    ...
    static EditorGUICustom()
    {
        ...
        TitleLabel.normal.textColor =
            EditorGUIUtility.isProSkin ? new Color(1, 1, 1, 0.8f) : new Color(0.2f, 0.2f, 0.2f, 0.8f);
        ...
        ShortTitleLabel.normal.textColor =
            EditorGUIUtility.isProSkin ? new Color(1, 1, 1, 0.8f) : new Color(0.2f, 0.2f, 0.2f, 0.8f);
